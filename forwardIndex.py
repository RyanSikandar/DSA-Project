...
with open("dataset.json", "r") as dataset:
    ...
    for article_id, article in articles.items():                                                    #ARTICLE
        ...
        for word_id in title_words_ids:
            forwardIndex[article_id][word_id] += 25
